...
.tag.green{background:rgba(34,197,94,.12);color:#adf2bf}.tag.orange{background:rgba(245,158,11,.12);color:#ffd697}.tag.red{background:rgba(239,68,68,.12);color:#feb2b2}.tag.blue{background:rgba(59,130,246,.12);color:#b8d6ff}.tag.gray{background:rgba(107,114,128,.12);color:#d1d5db;border:1px solid rgba(156,163,175,.25)}
...
.admin-status-overview{margin-bottom:18px}
.admin-status-dl{margin:0;padding:0;display:grid;gap:0}
.admin-status-row{display:grid;grid-template-columns:minmax(140px,32%) minmax(0,1fr);gap:10px 16px;padding:10px 0;border-bottom:1px solid rgba(255,255,255,.06);align-items:baseline}
.admin-status-row:last-child{border-bottom:none;padding-bottom:0}
.admin-status-row dt{margin:0;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}
