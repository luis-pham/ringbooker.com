...
.workspace{padding:16px;border:1px solid var(--line);background:linear-gradient(180deg,rgba(124,58,237,.14),rgba(17,24,43,.55));border-radius:20px;margin-bottom:18px;box-shadow:var(--shadow)}
.workspace h3{margin:0 0 5px;font-size:15px}
.workspace p{margin:0;color:var(--muted);font-size:12px;line-height:1.55}
...
.sidebar-foot{position:absolute;left:18px;right:18px;bottom:22px;background:linear-gradient(180deg,#0f1729,#0b1325);border:1px solid var(--line);border-radius:18px;padding:16px}
.sidebar-foot strong{display:block;font-size:13px}
.sidebar-foot small{display:block;color:var(--muted);line-height:1.55;margin-top:5px}
      ...
      <div className="app-shell"><aside className="sidebar"><div className="brand"><div className="brand-mark"><div className="brand-ripple r3" /><div className="brand-ripple r2" /><div className="brand-core"><svg viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" /></svg></div></div><span>RingBooker Admin</span></div><div className="workspace"><h3>Operations overview</h3><p>Monitor salons, telecom status, billing, and team access from one place.</p></div><div className="nav-label">Backoffice</div><div className="nav-list"><a className="nav-item active" href="/admin"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M4 13h6V4H4zM14 20h6v-9h-6zM14 10h6V4h-6zM4 20h6v-3H4z" /></svg></div><span>Overview</span></a><a className="nav-item " href="/admin/shops"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M3 10l2-5h14l2 5" /><path d="M4 10h16v10H4z" /><path d="M9 20v-6h6v6" /></svg></div><span>Shops</span></a><a className="nav-item " href="/admin/shops/luxe-hair-studio"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" /><path d="M5 20c1.5-3 4-4.5 7-4.5S17.5 17 19 20" /></svg></div><span>Shop Detail</span></a><a className="nav-item " href="/admin/calls"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.8 19.8 0 0 1 3.1 5.18 2 2 0 0 1 5.08 3h3a2 2 0 0 1 2 1.72l.42 3a2 2 0 0 1-.57 1.73l-1.27 1.27a16 16 0 0 0 6.44 6.44l1.27-1.27a2 2 0 0 1 1.73-.57l3 .42A2 2 0 0 1 22 16.92Z" /></svg></div><span>Calls &amp; Incidents</span></a><a className="nav-item " href="/admin/billing"><div className="nav-icon"><svg viewBox="0 0 24 24"><rect x={3} y={5} width={18} height={14} rx={2} /><path d="M3 10h18" /></svg></div><span>Billing</span></a><a className="nav-item " href="/admin/users"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2" /><circle cx="9.5" cy={7} r={3} /><path d="M20 8v6" /><path d="M17 11h6" /></svg></div><span>Users &amp; Roles</span></a><a className="nav-item " href="/admin/system-health"><div className="nav-icon"><svg viewBox="0 0 24 24"><path d="M3 12h4l2-5 4 10 2-5h6" /></svg></div><span>System Health</span></a></div><div className="sidebar-foot"><strong>Internal access only.</strong><small>Paddle handles salon subscription billing. Customer deposits remain disabled in this MVP.</small></div></aside><main className="main"><div className="topbar"><div className="page-title"><h1>Operations overview.</h1><p>Monitor shops, calls, billing, jobs, and incident signals across the full RingBooker network.</p></div><div className="top-actions"><a className="btn" href="/admin/users">Review admins</a><a className="btn purple" href="/admin/shops">Open shops</a></div></div>
          ...
          <section className="call-grid" style={{marginTop: 18}}>
            <div className="card hero-admin">
              ...
              <div className="live-copy">Telnyx voice, LiveKit media, Gemini realtime, and background jobs are running inside healthy thresholds. Two shops need onboarding follow-up and one account is approaching trial expiry.</div>
          ...
          <section className="kpi-row" style={{marginTop: 18}}>
            <div className="card"><div className="panel-head"><div><h3>Account activity</h3><p className="sub">Newest operational signals across the network.</p></div><a className="btn ghost" href="/admin/shops">Open shops</a></div>
              <table className="table"><thead><tr><th>Shop</th><th>Status</th><th>Calls today</th><th>Conversion</th><th>Plan</th></tr></thead><tbody>
            ...
            <div className="card soft"><div className="panel-head"><div><h3>System mix</h3><p className="sub">Current platform usage.</p></div></div>
              <div className="progress-list">
                <div className="progress-item"><strong>Google Calendar shops</strong><div className="bar"><span style={{width: '82%'}} /></div><span>19</span></div>
                <div className="progress-item"><strong>Manual fallback shops</strong><div className="bar"><span style={{width: '24%'}} /></div><span>5</span></div>
