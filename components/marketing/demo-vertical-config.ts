...
export const DEMO_VERTICALS: Record<DemoVerticalSlug, DemoVerticalConfig> = {
  'nail-salon': {
    ...
    icon: 'N',
    accent: '#7C3AED',
    title: 'Hear a Nail Salon Demo',
    subtitle: 'Call in, or paste your website — hear your AI receptionist answer as your nail salon.',
  ...
  'hair-salon': {
    ...
    icon: 'H',
    accent: '#B45309',
    title: 'Hear a Hair Salon Demo',
    subtitle: 'Call in, or paste your website — hear your AI receptionist answer as your hair salon.',
  ...
  'day-spa': {
    ...
    icon: 'S',
    accent: '#0D9488',
    title: 'Hear a Day Spa Demo',
    subtitle: 'Call in, or paste your website — hear your AI receptionist answer as your day spa.',
  ...
  'med-spa': {
    ...
    icon: 'M',
    accent: '#4F46E5',
    title: 'Hear a Med Spa Demo',
    subtitle: 'Call in, or paste your website — hear your AI receptionist answer as your med spa.',
  ...
  'beauty-clinic': {
    ...
    icon: 'C',
    accent: '#A21CAF',
    title: 'Hear a Beauty Clinic Demo',
    subtitle: 'Call in, or paste your website — hear your AI receptionist answer as your beauty clinic.',
