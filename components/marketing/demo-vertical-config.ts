...
export const DEMO_VERTICALS: Record<DemoVerticalSlug, DemoVerticalConfig> = {
  'nail-salon': {
    ...
    subtitle: 'Try a live web demo with sample nail studio context.',
  ...
  'hair-salon': {
    ...
    subtitle: 'Try a live web demo with sample hair salon context.',
  ...
  'day-spa': {
    ...
    subtitle: 'Try a live web demo with sample day spa context.',
  ...
  'med-spa': {
    ...
    subtitle: 'Try a live web demo with sample med spa context.',
  ...
  'beauty-clinic': {
    ...
    subtitle: 'Try a live web demo with sample beauty clinic context.',
