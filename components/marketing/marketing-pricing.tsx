            ...
            <div className="container">
              <div className="hero-copy">
                ...
                <div className="pricing-hero-copy">
                  <p className="hero-eyebrow pricing-hero-eyebrow">{content.hero.eyebrow}</p>
                    ...
                    {content.hero.trust.map((item, index) => (
                      <Fragment key={item}>
                        ...
                        <span className="pricing-hero-trust-item">
                          <span className="pricing-hero-trust-check" aria-hidden>✓</span>
                          {item}
                        </span>
                      </Fragment>
                    ))}
