...
const styles = [
  String.raw`:root{--demo-hub-purple:#8B5CF6;--demo-hub-purple-dark:#7C3AED;--demo-hub-text:#111827;--demo-hub-muted:#6B7280;--demo-hub-border:#E8ECF1;--demo-hub-soft:#F9FAFB;--demo-hub-shadow:var(--mk-shadow-soft,0 20px 40px -8px rgba(17,24,39,.06),0 8px 16px -6px rgba(17,24,39,.04));--demo-hub-shadow-hover:var(--mk-shadow-hover,0 22px 44px -8px rgba(17,24,39,.09),0 10px 20px -6px rgba(17,24,39,.05));--r-lg:24px;--r-xl:28px}*{box-sizing:border-box}.demo-hub{padding-top:68px;background:radial-gradient(ellipse 82% 58% at 50% -8%,#EDE9FE 0%,#FDF4FF 38%,#fff 78%)}.demo-hub-inner{max-width:1200px;margin:0 auto;padding-left:22px;padding-right:22px}.demo-hub-hero{padding:72px 0 28px;text-align:center}.demo-hub-hero h1{margin:22px auto 0;max-width:820px;font-size:clamp(34px,5.2vw,56px);line-height:1.06;letter-spacing:-.04em;color:var(--demo-hub-text);font-weight:600}.demo-hub-lead{margin:16px auto 0;max-width:640px;font-size:17px;line-height:1.72;color:var(--mk-text-desc,#64748B);font-weight:400}.demo-hub-trust{margin:40px auto 0;display:flex;justify-content:center;gap:24px;flex-wrap:wrap;max-width:720px}.demo-hub-chip{display:inline-flex;align-items:center;gap:6px;padding:0;border:none;background:transparent;border-radius:0;box-shadow:none;font-size:13px;font-weight:500;color:#6B7280}.demo-hub-chip::before{content:'✓';color:#10B981;font-weight:500;line-height:1}.demo-hub-chip svg{display:none}.demo-hub-scroll{margin-top:22px}.demo-hub-scroll a{font-size:14px;font-weight:500;color:var(--demo-hub-purple-dark);text-decoration:none;border-bottom:1px solid rgba(124,58,237,.35);padding-bottom:2px}.demo-hub-scroll a:hover{color:#5B21B6;border-color:#5B21B6}.demo-hub-picks{padding:36px 0 56px}.demo-hub-picks h2{font-size:13px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:var(--mk-text-desc,#64748B);text-align:left;margin:0 0 20px}.demo-hub-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:16px;width:100%}.demo-hub-card{background:#fff;border:1px solid var(--demo-hub-border);border-radius:var(--radius-lg,24px);padding:22px 20px;text-decoration:none;color:inherit;display:block;transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease,background .2s ease;text-align:center;box-shadow:var(--mk-shadow-soft,none)}.demo-hub-card:hover{transform:translateY(-2px);border-color:rgba(196,181,253,.55);box-shadow:var(--demo-hub-shadow-hover);background:#fff}.demo-hub-card:focus-visible{outline:2px solid #8B5CF6;outline-offset:2px}.demo-hub-card-mark{width:auto;height:auto;border-radius:0;display:flex;align-items:center;justify-content:center;margin:0 auto 12px;flex-shrink:0;background:transparent;border:0}.demo-hub-emoji-icon{font-size:30px;line-height:1}.demo-hub-card h3{margin:0;font-size:15px;font-weight:600;letter-spacing:-.01em;color:var(--demo-hub-text);line-height:1.3}.demo-hub-card-line{margin:7px 0 0;font-size:12px;line-height:1.5;color:var(--demo-hub-muted)}.demo-hub-card-cta{margin-top:10px;display:inline-flex;align-items:center;justify-content:center;gap:5px;color:#6D28D9;font-size:13px;font-weight:500}.demo-hub-card-cta svg{width:14px;height:14px;flex-shrink:0}.demo-hub-steps{padding:48px 0 88px;background:linear-gradient(180deg,rgba(249,250,251,.65) 0%,#fff 100%)}.demo-hub-steps h2{text-align:center;margin:0 auto 14px;font-size:clamp(22px,3vw,28px);font-weight:500;letter-spacing:-.03em;color:var(--demo-hub-text)}.demo-hub-steps>.demo-hub-inner>p{margin:0 auto 32px;text-align:center;max-width:520px;font-size:15px;color:var(--mk-text-desc,#64748B);line-height:1.68}.demo-hub-step-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.demo-hub-step{background:#fff;border:1px solid var(--demo-hub-border);border-radius:var(--r-lg);padding:22px 20px;box-shadow:var(--demo-hub-shadow);text-align:center;transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease,background .2s ease}.demo-hub-step:hover{transform:translateY(-2px);border-color:rgba(196,181,253,.55);box-shadow:var(--demo-hub-shadow-hover);background:#fff}.demo-hub-step-num{width:36px;height:36px;border-radius:50%;background:var(--demo-hub-purple);color:#fff;font-size:14px;font-weight:500;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;box-shadow:0 8px 22px rgba(124,58,237,.22)}.demo-hub-step h3{margin:0 0 8px;font-size:16px;font-weight:500;color:var(--demo-hub-text)}.demo-hub-step p{margin:0;font-size:14px;line-height:1.55;color:var(--demo-hub-muted)}@media (max-width:1100px){.demo-hub-step-grid{grid-template-columns:1fr}}@media (max-width:768px){.demo-hub-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (max-width:640px){.demo-hub-hero{padding-top:56px;text-align:left}.demo-hub-hero .hero-eyebrow{display:none}.demo-hub-hero h1{margin-left:0;margin-right:0;max-width:100%;text-align:left}.demo-hub-grid{grid-template-columns:1fr}.demo-hub-card{min-height:0}.demo-hub-trust{gap:12px}}.demo-hub-faq{background:#fff;padding:8px 0 24px}`,
];
