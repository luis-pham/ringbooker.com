...
const styles: string[] = [
  String.raw`
    ...
    *{box-sizing:border-box}
    ...
    .nsd-badge{display:inline-flex;padding:8px 16px;border-radius:999px;border:1px solid rgba(139,92,246,.3);background:#fff;color:var(--purple-dark);font-size:13px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;margin-bottom:18px}
    .nsd-inner h1{margin:0 0 14px;font-size:clamp(28px,4.5vw,40px);line-height:1.1;letter-spacing:-.03em;color:var(--text-dark);font-weight:900}
    ...
    .nsd-btn{display:inline-flex;align-items:center;justify-content:center;border-radius:999px;padding:14px 22px;font-size:15px;font-weight:800;text-decoration:none;transition:.18s}
