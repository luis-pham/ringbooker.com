...
.onb-field input,.onb-field select,.provider-card input,.provider-card select,.platform-selector select,.platform-panel input,.platform-panel select,.hours-row select{height:48px;border:1.5px solid #e2e8f0;border-radius:10px;padding:12px 16px;font-size:16px;background:#fff;color:#1a1a1a;width:100%;font-family:inherit}.onb-field input:focus,.onb-field select:focus,.provider-card input:focus,.provider-card select:focus,.platform-selector select:focus,.platform-panel input:focus,.platform-panel select:focus,.hours-row select:focus{border-color:#7c3aed;outline:none;box-shadow:0 0 0 3px rgba(124,58,237,.1)}.onb-field input::placeholder,.provider-card input::placeholder,.platform-panel input::placeholder{color:#9ca3af;font-size:15px}
