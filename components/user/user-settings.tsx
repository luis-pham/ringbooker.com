...
.service-group-card summary strong{font-size:20px;font-weight:600;color:var(--text-dark);letter-spacing:-.02em}
.service-group-card summary span{font-size:18px;color:var(--text-gray);font-weight:500}
