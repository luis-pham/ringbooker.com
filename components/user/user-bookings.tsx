      ...
      <div className="app-shell">
        <aside className="sidebar">
          <div className="sidebar-inner">
            ...
            <div className="workspace"><h3>Luxe Hair Studio</h3><p>42 upcoming appointments · 8 waiting for confirmation.</p></div>
            ...
            <div className="sidebar-foot"><strong>Smart reminders on.</strong><small>Customers receive confirmation and reminder texts automatically.</small></div>
          </div>
        </aside>
        <main className="main">
