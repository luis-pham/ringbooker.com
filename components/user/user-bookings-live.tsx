      ...
      <div className="app-shell">
        <aside className="sidebar">
          <div className="sidebar-inner">
            ...
            <div className="sidebar-foot"><strong>Bookings stay in sync.</strong><small>Use this page to review upcoming work and spot appointments that still need confirmation.</small></div>
          </div>
        </aside>
        <main className="main">
