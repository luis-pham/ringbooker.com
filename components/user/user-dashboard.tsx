      ...
      <div className="app-shell">
        <aside className="sidebar">
          <div className="sidebar-inner">
            ...
            <div className="sidebar-foot"><strong>Need help onboarding?</strong><small>Vietnamese support available for setup, forwarding, and service menu configuration.</small></div>
          </div>
        </aside>
        <main className="main">
