      ...
      <div className="app-shell">
        <aside className="sidebar">
          <div className="sidebar-inner">
            ...
            <div className="sidebar-foot"><strong>Paddle billing.</strong><small>Salon subscription billing is separate from any future customer deposit/payment flows.</small></div>
          </div>
        </aside>
        <main className="main">
