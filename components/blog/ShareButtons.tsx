...
export function ShareButtons() {
  ...
  const twitter = url ? `https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}` : '#';
  const linkedin = url ? `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}` : '#';
