    ...
    },
    {
      ...
      tools: [
        ...
        },
        {
          ...
          title: 'Vagaro',
          body: 'Checks real-time availability and sends your Vagaro booking link via SMS when callers want to book — no API booking creation required.',
          status: 'Availability + Booking link',
          statusKind: 'workflow',
        },
        {
          href: '/works-with',
