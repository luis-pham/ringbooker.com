---
{
  "meta": {
    ...
    "description": "Recover and protect revenue lost to missed calls: after-hours and peak-hour coverage so beauty businesses capture booking intent before callers book elsewhere.",
    "canonical": "/missed-booking-protection"
  },
  "schema": {
    "page_name": "Missed Booking Protection for Salons & Spas | RingBooker",
    "page_description": "Recover and protect revenue lost to missed calls: after-hours and peak-hour coverage so beauty businesses capture booking intent before callers book elsewhere.",
    "topic": "Missed Booking Protection"
  },
  "variant": "purple",
  ...
  "hubBlocks": [
    ...
    },
    {
      ...
      "html": {
        "eyebrow": "The RingBooker Approach",
        "scenarioGrid2x2": true
      },
      "heading": {
        "kind": "sectionTitle",
  ...
  "resourceSub": "Browse articles on missed calls, after-hours calls, peak-hour overflow, and missed booking protection for beauty businesses.",
  "faqs": [
    {
