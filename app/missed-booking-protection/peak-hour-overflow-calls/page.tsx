...
const sections: SeoSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        When someone calls a salon during peak hours and hears a busy signal, an endless ring, or a voicemail prompt, they hit the same failure mode described in{' '}
        <Link href="/missed-booking-protection/why-voicemail-is-a-dead-end-for-busy-salons">
          voicemail is a dead end for busy salons
        </Link>
        — they are in the middle of a decision, not pausing politely. They have a free slot in their schedule. They want to book something. They are not committed to your business yet — they are evaluating whether reaching you is easier than reaching someone else. At the moment voicemail picks up or the line is busy, that evaluation ends in favor of a competitor.
      </>,
      <>
    ...
    subsections: [
      {
        ...
        paragraphs: [
          <>
            <Link href="/industries/nail-salon">Nail salon calls</Link> spike during the heaviest overflow windows — <strong>Saturday mornings (9am–12pm)</strong> and{' '}
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            : nuance does not travel through a busy signal. Those calls are especially hard to recover after the fact. The callback has to match not just availability but stylist preference, service timing, and the client’s original urgency.
          </>,
        ],
      },
      {
        ...
        paragraphs: [
          <>
            Spa overflow tends to concentrate on <strong>weekend mornings and holiday weeks</strong>. Couples massage availability,{' '}
            <Link href="/industries/spa/how-couples-massage-inquiries-get-lost-before-they-book">spa package questions</Link>, and gift booking requests all arrive at once when leisure planning peaks. The same long-form intent behind{' '}
            <Link href="/industries/spa/how-after-hours-booking-demand-still-matters-for-spas">
              after-hours booking demand still matters for spas
            </Link>{' '}
            shows up here in real time — only the business is open and the front desk is what is underwater. Spa callers tend to have more context to share than nail salon callers. They are not asking a quick yes/no question — they want to discuss options. When overflow pushes them to voicemail, that conversation never happens, and the package sale is lost.
          </>,
        ],
      },
      {
        ...
        paragraphs: [
          <>
            For med spas and clinics, overflow during <strong>consultation booking windows</strong> is the most expensive loss scenario — especially{' '}
  ...
  },
  {
    ...
    orderedList: [
      ...
      <>
        <strong>Complex situations are flagged for </strong>
        <Link href="/trust/what-happens-if-a-caller-wants-a-real-person">human follow-up</Link>
        <strong> — with full call context so the team is not starting cold</strong>
      </>,
    ],
    trailParagraphs: [
      <>
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        ...
        <Link href="/missed-booking-protection/missed-call-recovery">Missed-call recovery</Link>, including ways to{' '}
        <Link href="/trust/can-ringbooker-text-missed-callers-automatically">text missed callers automatically</Link>, adds a third layer for callers who still slip through during extreme spikes, giving them a path to reconnect rather than a dead end.
      </>,
    ],
  },
  {
    ...
    paragraphs: [
      <>
        RingBooker sits on the phone layer through <Link href="/current-number/call-forwarding">call forwarding</Link>. You{' '}
        <Link href="/current-number">keep your current number</Link> and keep using your existing booking workflow. That matters because beauty businesses win on convenience and continuity. Callers keep dialing the number on your Google Business Profile, your Instagram bio, and your website — supporting{' '}
        ...
        . Your team keeps using Square, Vagaro, Booksy, or whatever system you already have. Nothing changes for the client. Nothing changes for the team. What changes is what happens to the calls that would have previously gone unanswered.
      </>,
    ],
  },
];
